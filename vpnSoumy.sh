...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/soumymafia/soumysc/master/nginx-default.conf"
mkdir -p /home/vps/public_html
echo "<?php phpinfo() ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/soumymafia/soumysc/master/vhost-nginx.conf"
...
wget -O /etc/apache2/ports.conf "https://raw.githubusercontent.com/soumymafia/soumysc/master/apache2.conf"

# Edit port virtualhost apache2 ke 8090
wget -O /etc/apache2/sites-enabled/000-default.conf "https://raw.githubusercontent.com/soumymafia/soumysc/master/virtualhost.conf"
...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/soumymafia/soumysc/master/vars.conf"
